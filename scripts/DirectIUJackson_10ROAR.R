...
nBootCI = 1000            # number of bootstrap runs to compute CI - should be 1000 for 10, 220 for 4
...
runlength = 400           # number of customers per replication (excluding those deleted)
...
# following write command for parallel processing environment
#write.table(format(macroResults, digits=4),paste0("./JacksonD10runs/",as.character(NAI),"/JacksonD10out.txt"),
#            append=TRUE,eol="\n",
#            quote=FALSE,
#            row.names=FALSE,col.names=FALSE)

write.table(format(macroResults, digits=4),paste0("./JacksonD10out.txt"),
            append=TRUE,eol="\n",
            quote=FALSE,
            row.names=FALSE,col.names=FALSE)
