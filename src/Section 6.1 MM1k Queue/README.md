This folder contains three R function codes and one R script used to run the M/M/1/k queue example presented in the paper (RunMM1kExpr.R). The functions are described below:
