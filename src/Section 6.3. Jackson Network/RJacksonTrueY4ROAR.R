...
runlength = 400           # number of customers recorded 
...
write.table(format(results, digits=4),paste0("./JacksonD4runs/",as.character(NAI),"/JacksonD4out.txt"),
            append=TRUE,eol="\n",
            quote=FALSE,
