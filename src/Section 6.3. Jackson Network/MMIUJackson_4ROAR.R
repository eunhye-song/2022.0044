...
#write.table(format(macroResults, digits=4),paste0("./JacksonMM4runs/",as.character(NAI),"/JacksonMM4out.txt"),
#            append=TRUE,eol="\n",
#            quote=FALSE,
#            row.names=FALSE,col.names=FALSE)

write.table(format(macroResults, digits=4),paste0("./JacksonMM4out.txt"),
            append=TRUE,eol="\n",
            quote=FALSE,
            row.names=FALSE,col.names=FALSE)
